...
from .views import WorkFlowListCreateView,WorkFlowDetailView,WorkFlowStepsListCreateView,WorkFlowStepDetailView
...
urlpatterns=[
    ...
    path('workflows/steps/<int:pk>/', WorkFlowStepDetailView.as_view()),
